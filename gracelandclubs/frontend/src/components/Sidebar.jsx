...
import "./Sidebar.css";
import { FaHome, FaCalendarAlt, FaUser, FaFileAlt, FaBars, FaRegCircle } from "react-icons/fa";

const Sidebar = ({ items = ["Home", "Calendar", "Account", "File"], activeItem, onItemSelect }) => {
